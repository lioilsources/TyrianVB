...
Public Declare PtrSafe Function GdipAddPathRectangle Lib "gdiplus" (ByVal Path As LongPtr, ByVal x As Single, ByVal y As Single, _
        ByVal w As Single, ByVal h As Single) As GpStatus
Public Declare PtrSafe Function GdipAlloc Lib "gdiplus" (ByVal size As Long) As LongPtr
...
Public Declare PtrSafe Function GdipCreateBitmapFromFile Lib "gdiplus" (ByVal filename As String, Bitmap As LongPtr) As GpStatus
